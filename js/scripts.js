$(document).ready(function(){
  ...
  var course;
    ...
    if(choice1 === 1 && choice2 === 1 && choice3 === 1 && choice4 === 2 && choice5 === 3) {
      ...
      } else if(choice1 === 3 && choice2 === 2 && choice3 === 2 && choice4 === 3 && choice5 === 4){
          course = "Your best fit is 'C#/.Net' and 'CSS/Design'. You have years of expirience with programming which will be benificial in understanding new languages. If you are familiar with 'C#/.Net' maybe look into java as its also an object oriented programming language. You shouldn't have problems solved for you. You can do this!";
      } else if(choice1 === 1 && choice2 === 4 && choice3 === 1 && choice4 === 2 && choice5 === 2){
